...
const PREGUNTAS = {
  'SC-01': '¿El local cumple con la presentación y estado físico?',
  ...
  'SC-05': '¿Cumple con persuasión de promociones LUX? — Presencial',
  'SC-06': '¿Cumple con persuasión de promociones LUX? — Llamadas',
  'SC-07': '¿Cumple con persuasión de promociones LUX? — WhatsApp',
  'SC-08': '¿Cuenta con publicidad física vigente y en buen estado?',
  'SC-09': '¿Se realiza el ofrecimiento de adicionales?',
  'SC-10': '¿Tiene respuestas rápidas en WhatsApp Business?',
  'SC-11': '¿Tiene promociones vigentes y actualizadas?',
  'SC-12': 'Sin listas de difusión masiva — WhatsApp',
  'SC-13': '¿Tiene contactos de clientes guardados correctamente?',
  'SC-14': '¿Existe conocimiento de carta por parte del equipo?',
  'SC-15': '¿Cuentan con equipos operativos?',
  'SC-16': 'Ruta de flyers realizada (menos de 2 días)',
  ...
  'CF-04': '¿Se encuentra el mise en place en condiciones adecuadas?',
  'CF-05': '¿Cumple con los gramajes estándar y control de calidad?',
  'CF-06': '¿Se realiza la rotulación de salsas y preparaciones?',
  'CF-07': '¿Cuenta con plaquetas con gramaje adecuado?',
  'CF-09': '¿Realizan correctamente la dilución de antioxidante?',
  'CF-10': '¿Realizan el lavado y almacenamiento de verduras correctamente?',
  'CF-11': '¿Se mantiene control de temperatura en refrigeración?',
  'CF-12': '¿Se realiza la descongelación correcta de pollo y reineta?',
  'CF-13': '¿Se realiza correctamente el Ceviche?',
  'CF-14': '¿Se realiza correctamente el sellado de rollos (no fritos)?',
  'CC-01': '¿Se realiza correctamente el batido del huevo?',
  'CC-02': '¿Se realiza correctamente el proceso de apanado?',
  'CC-03': '¿Se mantiene el control de temperatura de la freidora?',
  'CC-04': '¿Se realiza correctamente el sellado de puntas en rolls fritos?',
  'CC-05': '¿Se realiza correctamente el control de grumos?',
  'CC-06': '¿Se usan correctamente las tablas de cortar?',
  'CC-07': 'Estandarización de cortes del roll',
  'CC-08': '¿Se realiza afilado y mantenimiento de cuchillos?',
  'CC-09': '¿Se realiza correctamente el aliñado del pollo?',
  'CC-10': '¿Cumple con la elaboración correcta de recetas de salsas?',
  'CC-11': 'Calidad y estado del aceite de fritura',
  'CC-12': '¿Presentan dudas en elaboraciones básicas o complejas?',
  'CC-13': '¿La campana extractora está operativa y limpia?',
  'CC-14': '¿Se realiza limpieza diaria y profunda de las áreas?',
  'CC-15': '¿Se realiza la limpieza y sanitización del área de trabajo?',
